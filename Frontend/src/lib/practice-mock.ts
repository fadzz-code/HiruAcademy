...
export type PracticeQuestion = { id: string; prompt: string; options: string[]; answer: number };
...
const questions: PracticeQuestion[] = [
  { id: "q1", prompt: "Manakah tulisan Jepang untuk “bahasa Jepang”?", options: ["日本語", "英語", "中国語", "韓国語"], answer: 0 },
  { id: "q2", prompt: "Apa arti “おはよう”?", options: ["Selamat pagi", "Terima kasih", "Sampai jumpa", "Selamat malam"], answer: 0 },
  { id: "q3", prompt: "Manakah hiragana untuk bunyi “ka”?", options: ["か", "さ", "た", "な"], answer: 0 },
];
