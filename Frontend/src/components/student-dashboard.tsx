    ...
    <div className="dashboard-shell student-shell">
      ...
      <div className="dash-main">
        ...
        <main className="dash-content">
          ...
          <section className="dash-welcome"><div><p className="dash-kicker">{config.eyebrow}</p><h1>{config.heading}</h1><p>{config.description}</p></div><div className={`membership-badge membership-${data.membership}`}>{config.badge}</div></section>
