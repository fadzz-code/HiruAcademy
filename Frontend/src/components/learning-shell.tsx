...
export function LearningShell({ membership, level, current, children }: { membership: Membership; level: string; chapter: string; current: "overview" | "video" | "document" | "flashcards" | "audio" | "reading"; children: ReactNode }) {
