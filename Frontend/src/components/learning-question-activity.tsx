...
export function LearningQuestionActivity({ data, variant }: { data: LearningData; variant: "audio" | "reading" }) {
  ...
  return <div className="learning-question-page">
    <header className="learning-question-head"><h1>{isAudio ? "Dengarkan percakapan dan pilih jawaban yang tepat" : "Baca teks pendek lalu jawab pertanyaan"}</h1><p>{isAudio ? "Audio dapat diputar ulang sesuai konfigurasi soal." : "Teks Jepang Profesional dapat memiliki state Jepang Pemula pada implementasi."}</p></header>
